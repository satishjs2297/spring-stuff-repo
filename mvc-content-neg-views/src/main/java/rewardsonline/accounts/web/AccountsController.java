...
public class AccountsController {
	...
	public String list(Principal prinicpal, Model model) {
		if (prinicpal == null)
			throw new RuntimeException("Not authenitcated");
	...
	public String throwAccessDeniedException(Exception ex){
		System.out.println(">>>throwAccessDeniedException>>>>>>>>");
		return "accounts/accesserror";
	}
